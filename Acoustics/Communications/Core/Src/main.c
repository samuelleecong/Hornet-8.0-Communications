...
int main(void)
{
  ...
  bool ret;
  strcpy((char*)buf, "spiinit..\r\n");
  HAL_UART_Transmit(&huart3, buf, strlen((char*)buf), HAL_MAX_DELAY);
  ret = CANSPI_Initialize() ;
//  if (MCP2515_Initialize()){
//	  strcpy((char*)buf, "mcpinit\r\n");
//	  HAL_UART_Transmit(&huart3, buf, strlen((char*)buf), HAL_MAX_DELAY);
//  }
//  else{
//	  strcpy((char*)buf, "mcpnoinit\r\n");
//	  HAL_UART_Transmit(&huart3, buf, strlen((char*)buf), HAL_MAX_DELAY);
//  }
//  bool a = MCP2515_SetConfigMode();
//  char canctrl = MCP2515_ReadByte(0x0F);
//  char string[5] = "help";
//  strncat(string,&canctrl,1);
...
//  HAL_GPIO_WritePin(LD2_GPIO_Port, LD2_Pin, GPIO_PIN_SET);
  ...
  if(ret == false){
	...
	strcpy((char*)buf, "failure\r\n");
    HAL_UART_Transmit(&huart3, buf, strlen((char*)buf), HAL_MAX_DELAY);
//	while(1){
//		  uint8_t buf[12];
//		  strcpy((char*)buf, "SPInoInit\r\n");
//		  HAL_UART_Transmit(&huart3, buf, strlen((char*)buf), HAL_MAX_DELAY);
//	}
  }
  uint8_t msg[12];
  strcpy((char*)msg, "passed\r\n");
